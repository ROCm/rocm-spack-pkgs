...
rocm_spack_base_image="${docker_registry}/rocm-spack-base-${rocm_driver_version}:ub18.04"
...
rocm_spack_image=${docker_registry}/rocm-spack-"$rocm_driver_version":ub18.04
